 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
	...
	<div class="container-column-align" style="height: 100%; margin-top: 1rem;">
        <div class="container-column" style="width: 80vw; min-width: 259.2px;">
							...
							<c:forEach var="dto" items="${list}">
								<tr>
									...
									<td align="left">
										...
										<a href="humorboard/increment?bidx=${dto.bidx}&currentPage=${boardList.currentPage}">
											${subject}
										</a>
									</td>
		 ...
		 <!--버튼 + 페이징-->
                <div style="margin-bottom:5px; display:flex; align-items:center; justify-content:space-between;">
                    <input class="BlackWhite" style="width:7%; height:6vh; font-size:1rem;" type="button" value="전체글" onclick="location.href='humorboard'"/>
                    <input class="GrayWhite" style="width:7%; height:6vh; font-size:1rem;" type="button" value="추천글" onclick="location.href='humorboardsearch?searchType=recommendedNumber&searchText='"/>
                    ...
                    <form style="width:12%; height:6vh;" method="get" action="humorboard/write" onsubmit="return loginCheck('${Session_userID}');">
		...
		<!-- 글쓰기 버튼 -->
		 <!--검색-->
                <form action="humorboardsearch" style="display:flex; justify-content:center;">
