...
<div class="d-flex gap-md-2 flex-wrap" style="justify-content:center; height:100%; margin-top:1rem;">
    ...
    <!--중단1 -->
  <div class="card text-white bg-warning" style="width:34%; height:250px;align-item: center; justify-content:center; ">
...
<div class="card text-white bg-danger" style="width:34%; height:250px; align-item: center; justify-content:center;">
  ...
  <div class="card-body" style="align-item: center;">
    ...
    <!--//중단2 -->
     <!--중단3 -->
  <div class="card text-white bg-info" style="width:34%; height:250px;align-item: center; justify-content:center;">
...
<div class="card text-white bg-success" style="width:34%; height:250px; align-item: center; justify-content:center;">
