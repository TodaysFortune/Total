...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<div class="container-column-align" style="height: 100%; margin-top: 1rem;">
        <div class="container-column" style="width: 80vw; min-width: 259.2px;">
		 ...
		 <!--버튼 + 페이징-->
                <div style="margin-bottom:5px; display:flex; align-items:center; justify-content:space-between;">
                    ...
                    <input class="GrayWhite" style="width:7%; height:6vh; font-size:1rem;" type="button" value="추천글" onclick="location.href='/humorboard/humorboardsearch?searchType=recommendedNumber&searchText='"/>
		...
		<!-- 글쓰기 버튼 -->
		 <!--검색-->
                <form action="/humorboard/humorboardsearch" style="display:flex; justify-content:center;">
