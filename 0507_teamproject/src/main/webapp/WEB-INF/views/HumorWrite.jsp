...
<!-- 중단 -->
	<div class="container-column-align" style="height: 100%; margin-top:1rem;">
        <div class="container-column" style="width: 80vw; min-width: 259.2px;">
            ...
            <div><hr/></div>
            <form style="margin-top:10px;" action="/humorboard/write" method="post" onsubmit="return emptySubjectContentCheck();">
                ...
                <div style="display:flex; justify-content: flex-end;">
                    ...
                    <input class="GrayWhite"style="margin-left:7px;width:12%; height:6vh; font-size:1rem;" type="button" value="돌아가기" onclick="location.href='/humorboard?currentPage=${currentPage}'"/>
                </div>
            </form>
        </div>
    </div>
