        ...
        <div class="container-column" style="width: 80vw; min-width: 259.2px;">
            ...
            <div style="min-height: 5rem;">
                ...
                <form style="float:right;" class="relative-right unloginSet" method="post" onsubmit="return idmatching(this,'${Session_userID}');">
                    ...
                    <a style="cursor:pointer;background-color: white;border:0;text-decoration:none;color:black;" href="/itboard/contentView/update?id=${boardDTO.id}&bidx=${boardDTO.bidx}&currentPage=${currentPage}">수정</a>
                    &nbsp;<span>|</span>&nbsp;
            ...
            <div style="display:flex; justify-content: space-between; margin-bottom: 10px;">
	            ...
	            <div class="relative-right">
	            	<label  style="cursor:pointer" onclick="goodup('${Session_userID}','${boardDTO.bidx}','/itboard/contentView/')">
	            		<c:if test="${heart==0}">
            ...
            <div>
                ...
                <div style="width:100%;">
                    ...
                    <div style="display:flex;  justify-content: space-between; width:100%; margin-top:1rem; margin-bottom:1rem;">
                        ...
                        <form action="/itboard/contentView/deleteComment" method="post" onsubmit="return idmatching(this,'${Session_userID}')"
                    ...
                    <!--대덧글작성-->
                    <form action="/itboard/contentView/registerComment" method="post" onsubmit="return emptyTextCheck(this);" style="width:100%; margin-top: 5px; margin-bottom: 5px;" class="container-row display_visible">
            ...
            <!-- 덧글페이지 -->
            <form action="/itboard/contentView" style="display:flex; justify-content: center; margin-bottom: 7px;" class="nocomment">
            	<input type="hidden" name="currentPage" value="${currentPage}"/>
            	<input type="hidden" name="bidx" value="${boardDTO.bidx}"/>
            ...
            <!-- //덧글페이지 -->
            <form id="clientToServerText" action="/itboard/contentView/registerComment" method="post" onsubmit="return emptyTextCheck(this);">
                <!--덧글작성-->
