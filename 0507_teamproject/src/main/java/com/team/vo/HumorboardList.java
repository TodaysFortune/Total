...
public class HumorboardList {
	private List<HumorboardDTO> list = new ArrayList<HumorboardDTO>();
	...
	public List<HumorboardDTO> getList() {
		return list;
	}

	public void setList(List<HumorboardDTO> list) {
		this.list = list;
	}
	...
	public String toString() {
		return "HumorboardList [list=" + list + ", noSize=" + noSize + ", PageSize=" + PageSize + ", totalCount="
