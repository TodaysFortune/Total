...
public class HumorcommentList {
	List<HumorcommentDTO> list = new ArrayList<HumorcommentDTO>();
	...
	public List<HumorcommentDTO> getList() {
		return list;
	}
	public void setList(List<HumorcommentDTO> list) {
		this.list = list;
	}
	...
	public String toString() {
		return "HumorcommentList [list=" + list + ", noSize=" + noSize + ", totalCount=" + totalCount + ", totalPage="
